          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                isContentPicked ? NewContent() : Container(),
                Text(
                  TranslatedText().attachFile,
                        ...
                        PopupMenuButton<Idea>(
                          ...
                          onSelected: (Idea selectedIdea) {
                            setState(() {
                              ...
                              tittleController.text = selectedIdea.title;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          minLines: 1,
                          decoration: InputDecoration(
                            labelText: TranslatedText().caption +
                                TranslatedText().optional,
                          ),
                          textInputAction: TextInputAction.next,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText:
                                "#${TranslatedText().hashtag}${TranslatedText().optional}",
                          ),
                          textInputAction: TextInputAction.next,
                        ...
                        TextFormField(
                          ...
                          minLines: 1,
                          decoration: InputDecoration(
                            labelText: TranslatedText().voiceOT +
                                TranslatedText().optional,
                          ),
                          textInputAction: TextInputAction.next,
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                            labelText: TranslatedText().datePost +
                                TranslatedText().optional,
                          ),
                          textInputAction: TextInputAction.next,
                            ...
                            ElevatedButton(
                              onPressed: () {
                                if (isRequestFinished == true) {
                                  ...
                                  AppAlert().showFailedAlert(context,
                                      "Adding data is still in progress");
                                }
                              },
                              style: ElevatedButton.styleFrom(
                                foregroundColor: ColorPalette.black,
